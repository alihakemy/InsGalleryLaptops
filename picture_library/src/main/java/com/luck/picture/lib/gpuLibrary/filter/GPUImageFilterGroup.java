...
package com.luck.picture.lib.gpuLibrary.filter;
...
import com.luck.picture.lib.gpuLibrary.util.Rotation;
import com.luck.picture.lib.gpuLibrary.util.TextureRotationUtil;

import static com.luck.picture.lib.gpuLibrary.GPUImageRenderer.CUBE;
import static com.luck.picture.lib.gpuLibrary.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    /*
     * (non-Javadoc)
     * @see com.luck.picture.lib.gpuLibrary.filter.GPUImageFilter#onInit()
     */
    @Override
    public void onInit() {
        super.onInit();
    ...
    /*
     * (non-Javadoc)
     * @see com.luck.picture.lib.gpuLibrary.filter.GPUImageFilter#onDestroy()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * com.luck.picture.lib.gpuLibrary.filter.GPUImageFilter#onOutputSizeChanged(int,
     * int)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.luck.picture.lib.gpuLibrary.filter.GPUImageFilter#onDraw(int,

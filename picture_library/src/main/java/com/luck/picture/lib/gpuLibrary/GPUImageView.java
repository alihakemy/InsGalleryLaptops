...
import com.luck.picture.lib.gpuLibrary.filter.GPUImageFilter;
import com.luck.picture.lib.gpuLibrary.util.Rotation;

import static com.luck.picture.lib.gpuLibrary.GPUImage.SURFACE_TYPE_SURFACE_VIEW;
import static com.luck.picture.lib.gpuLibrary.GPUImage.SURFACE_TYPE_TEXTURE_VIEW;
    ...
    public Bitmap capture() throws InterruptedException {
        ...
        gpuImage.runOnGLThread(new Runnable() {
            ...
            public void run() {
                ...
                resultBitmap = GPUImageNativeLibrary.adjustBitmap(resultBitmap);
                waiter.release();
            }
        });
        requestRender();
